...
from lib import ZernioClient, parse_linkedin_url, render_approval_card
...
def main() -> int:
    ...
    platform_id = os.getenv("ZERNIO_LINKEDIN_ACCOUNT_ID")
    if not platform_id:
        print("✗ ZERNIO_LINKEDIN_ACCOUNT_ID not set in .env", file=sys.stderr)
        return 2
